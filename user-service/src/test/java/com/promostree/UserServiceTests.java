<<<<<<< HEAD:user-service/src/test/java/com/promostree/UserServiceTests.java
...
public class UserServiceTest {
	 ...
	 * user.setEmail("ananth@gmail.com"); user.setPhoneNumber("9035208863");
	 * User user1 = userService.saveUserCredentials(user);
